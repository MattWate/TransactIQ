...
style.textContent = `
  ...
  .image-band{background-image:linear-gradient(90deg,rgba(6,27,58,.93),rgba(6,27,58,.72)),url('assets/images/data-portfolio-dashboard.jpg')!important}.image-band.alt{background-image:linear-gradient(90deg,rgba(6,27,58,.92),rgba(6,27,58,.74)),url('assets/images/market-performance-chart.jpg')!important}
  ...
  .quote-card,.why-card,.talent-card,.vertical-intro,.approach-block{background:radial-gradient(circle at top right,rgba(32,198,223,.18),transparent 34%),linear-gradient(135deg,#071424,#08244D)!important}
  .icon-box{background:#DFF6FA!important}.btn-outline,input,textarea,select{background:#F5F9FC!important;border-color:var(--line)!important}.btn-outline:hover{background:#FFFFFF!important}
  .final-cta{background:transparent!important}.site-footer{background:#D0DEEC!important;border-top:1px solid var(--line)!important}.footer-inner{background:transparent!important}.footer-links,.footer-meta{color:#46596D!important}

  .hero-panel,.glass-card{border-radius:22px!important}.signal{border-radius:14px!important;background:rgba(255,255,255,.08)!important;border:1px solid rgba(255,255,255,.14)!important}.signal-number{border-radius:10px!important}
