...
style.textContent = `
  ...
  @media(max-width:1200px){.brand{width:245px!important;min-width:245px!important}.brand img{width:245px!important}.nav-links{gap:14px!important;font-size:.86rem!important}.nav-cta{padding-inline:18px!important}.tab-button{font-size:.8rem;padding:12px 8px;gap:6px}.tab-button::before{width:24px;height:24px;font-size:.66rem}}
